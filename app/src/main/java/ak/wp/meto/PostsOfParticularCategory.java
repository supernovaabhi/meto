...
import ak.wp.meto.constant.Const;
import ak.wp.meto.helper.CommonAdapter;
import ak.wp.meto.helper.DateConverter;
import androidx.appcompat.app.AppCompatActivity;

import ak.wp.meto.helper.Font;
import ak.wp.meto.helper.SingletonVolley;
import ak.wp.meto.model.JsonDataModel;
